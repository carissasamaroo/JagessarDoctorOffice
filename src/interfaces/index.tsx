...
export interface PatientAppointment {
	...
	appointmentDate?: string | null; // Use ISO 8601 string for DateTime
	appointmentTime?: string | null;
	notes?: string | null;
	created?: string | null; // Use ISO 8601 string for DateTime
	createdBy?: string | null;
	modified?: string | null; // Use ISO 8601 string for DateTime
	modifiedBy?: string | null;
	person?: Person | null;
}

// export interface Person {
// 	// Define the structure of the Person interface if it is not already available.
// 	// Example:
// 	id: number;
// 	name: string;
// 	// Add other relevant fields for the Person model.
// }
